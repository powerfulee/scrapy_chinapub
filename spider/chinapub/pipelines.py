...
class WebcrawlerScrapyPipeline(object):
    ...
    def _conditional_insert(self, conn, item, spider):
        ...
        conn.execute("insert into books (book_id, title, orig_price, vip_price, author, image_url, image_file_name, publishing, ISBN, sell_time, publish_time, category) values(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
